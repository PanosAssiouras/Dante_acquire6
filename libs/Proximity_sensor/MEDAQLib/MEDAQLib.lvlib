...
communication.</Property>
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="DataAvail.vi" Type="VI" URL="../../Public/Action-Status/DataAvail.vi"/>
			<Item Name="GetError.vi" Type="VI" URL="../Public/Action-Status/GetError.vi"/>
			...
			<Item Name="GetParameterString.vi" Type="VI" URL="../../Public/Action-Status/GetParameterString.vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			...
			<Item Name="SetParameterInt.vi" Type="VI" URL="../Public/Configure/SetParameterInt.vi"/>
			<Item Name="SetParameterString.vi" Type="VI" URL="../Public/Configure/SetParameterString.vi"/>
		...
		<Item Name="Data" Type="Folder">
			...
			<Item Name="Poll.vi" Type="VI" URL="../Public/Data/Poll.vi"/>
			<Item Name="TransferData.vi" Type="VI" URL="../../Public/Data/TransferData.vi"/>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="CloseSensor.vi" Type="VI" URL="../Public/Utility/CloseSensor.vi"/>
			...
			<Item Name="ErrorHandler.vi" Type="VI" URL="../Public/Utility/ErrorHandler.vi"/>
			...
			<Item Name="GetDLLPath.vi" Type="VI" URL="../Public/Utility/GetDLLPath.vi"/>
			<Item Name="OpenSensor.vi" Type="VI" URL="../../Utility/OpenSensor.vi"/>
			...
			<Item Name="OpenSensorRS232.vi" Type="VI" URL="../Public/Utility/OpenSensorRS232.vi"/>
			<Item Name="ReleaseSensorInstance.vi" Type="VI" URL="../Public/Utility/ReleaseSensorInstance.vi"/>
			...
			<Item Name="CreateSensorInstByName.vi" Type="VI" URL="../Public/Utility/CreateSensorInstByName.vi"/>
		</Item>
		<Item Name="Example" Type="Folder">
			...
			<Item Name="Interface-RS232.vi" Type="VI" URL="../../Interface-RS232.vi"/>
		</Item>
